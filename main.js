...
// const mergeArrayProducts = (products) => {
//   let array = products;
//   let product = array.map(element => {
//     let {title, description, price} = element;
//     let productToMerge = {name: title, description: description, price: price, availability: true};
...
//   let response = await fetch(`https://products-db-e6ed7-default-rtdb.firebaseio.com/products/.json`, {
//       method: "POST",
//       body: JSON.stringify(newProduct)
//   })
